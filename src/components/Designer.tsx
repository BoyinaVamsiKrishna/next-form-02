...
// import { FormBGProvider, BackgroundState, useFormBG } from '@/components/context/FormBackgroundContext';
// function Designer() {
...
//       <FormBGProvider>
//       <DynamicBackground>
//         <Card id='designercard' className='w-full h-full'>
//         <div 
...
//                   <div className='h-[120px] w-full rounded-md bg-primary/20'> 
//                   </div>
//                 </div>)}
//                   {elements.length > 0 && (
...
//     )} 
//     <div className={cn('flex w-full h-[120px] items-center rounded-md bg-accent/40 px-4 py-2 text-black dark:text-white pointer-events-none opacity-100', mouseIsOver && "opacity-30",)}>
...
//   const { backgroundState } = useFormBG();
...
// function DynamicBackground({ children }: { children: React.ReactNode }) {
//   const { formBackgroundState } = useFormBG();

//   const backgroundStyle = formBackgroundState.backgroundType === 'color'
//     ? { backgroundColor: formBackgroundState.backgroundColor }
//     : { backgroundImage: `url(${formBackgroundState.backgroundImage})` };
